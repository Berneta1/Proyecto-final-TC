const QuienesSomos = ()=> {
    ...
    return (
<div className="nosotros card mt-5 m-auto">
  <div className="row g-0">
    <div className="col-md-4 p-3">
      <img src="https://i.pinimg.com/originals/a2/85/94/a28594b135b40ec8c8644f6b2ae619a5.png" className="img-fluid rounded-start" alt="Quienes somos"/>
    </div>
